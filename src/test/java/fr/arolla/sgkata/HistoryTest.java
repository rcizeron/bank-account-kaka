...
public class HistoryTest {
    ...
    void should_have_one_operation_after_one_deposit() {
        Account account = new Account(BigDecimal.ZERO, LocalDate.of(2022, 1, 1));

        assertThat(Statement.getStatements(account).statements()).containsExactly(
                new Statement(Transaction.Type.DEPOSIT, LocalDate.of(2022, 1, 1), BigDecimal.ZERO, BigDecimal.ZERO)
        );
    }
